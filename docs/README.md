...
The active checkout keeps documentation that describes the current product or
an immediate integration boundary.
...
append-only decision ledger—is preserved at annotated tag
`v0.1.0-alpha.1`. The earlier governance-reset cut remains at
`pre-alpha-governance-reset-2026-08-07`. Neither archive is needed to install
or use the package.
