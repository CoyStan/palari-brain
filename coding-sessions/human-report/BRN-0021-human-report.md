...
already-detected failure or skip sidecars. The custody path now avoids those
mutable methods, captures the operations it needs before the callback, and has
four more permanent regressions. A second rereview is required.
